...
{
    public class xDataGridViewNumbericColumn : xDataGridViewTextBoxColumn
    {
        public xDataGridViewNumbericColumn()
        {
            this.ColumnContentType = ContentType.Numberic;
    ...
    //public class xDataGridViewNumbericCell : xDataGridViewTextBoxCell
    //{
    ...
    //        //this.Style.Format = this.Format;// Common.Format_Numberic;
    //    }
